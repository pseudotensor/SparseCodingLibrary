...
# Evaluate if the scl reconstruction error is within tolerance t of ksvd or better
def evaluate_case(c, t):
    ...
    scl_result = scl.sparse_code(X, c.dict_size, c.target_sparsity, c.iterations, sparse_updater=c.sparse_updater,
